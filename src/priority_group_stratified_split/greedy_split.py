...
class GreedySplit(Split):
    ...
    def _greedy_group_set(self, group_set: GroupSet, percentages:list[float], remaining_policy:str='w') -> GroupSet:
        ...
        # If there are any items left and one wants to force them into a knapsack  
